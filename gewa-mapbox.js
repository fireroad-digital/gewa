...
$(document).ready(function () {
  ...
  function setupMap(data) {
    ...
    map.on('click', 'csvData', function (e) {
      ...
      let orgLat = e.features[0].properties.OrgLatitude
      let orgLng = e.features[0].properties.OrgLongitude
      let url = `https://www.google.com/maps/dir//${orgLat},${orgLng}`;
      let description = `<h3>${e.features[0].properties.Name}</h3>`;
      description += `<h4><a target='_blank' href='${url}'>Directions</a></h4>`;
      description += `<h4><b>Address:</b> ${e.features[0].properties.Address}</h4>`;
